...
namespace IRunesWebApp.Controllers
{
    ...
    {       
        ...
        private const string LayoutViewFileNameLoggedIn = "_LayoutLoggedIn";

        private const string RenderBodyConstant = "@RenderBody()";

        private string[] LoggedOutViews = new [] {"Index", "Login", "Register"};
        ...
        {
            var currentLayout = string.Empty;

            if (this.LoggedOutViews.Contains(viewName))
            {
                currentLayout = LayoutViewFileName;

            }
            else
            {
                currentLayout = LayoutViewFileNameLoggedIn;
            }
